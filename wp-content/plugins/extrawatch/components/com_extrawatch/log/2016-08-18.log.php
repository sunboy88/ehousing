22:20:39 1471558839.49  P:   0 
                ...
                `value` TEXT default NULL COLLATE utf8_general_ci
  			    ...
  			    ALTER TABLE #__extrawatch_config ADD UNIQUE INDEX(name);
                ...
                ALTER TABLE #__extrawatch_uri2title ADD UNIQUE INDEX(uri);
...
22:20:39 1471558839.49  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch` (
                `id` int unsigned auto_increment primary key,
                `ip` varchar(255) default NULL COLLATE utf8_general_ci,
                `country` varchar(2) default NULL COLLATE utf8_general_ci,
                `browser` varchar(255) default NULL COLLATE utf8_general_ci,
...
22:20:39 1471558839.52  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_config` (
                `id` int unsigned auto_increment primary key,
                `name` varchar(255) default NULL COLLATE utf8_general_ci,
                `value` TEXT default NULL COLLATE utf8_general_ci
				) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci;
22:20:39 1471558839.54  P:   0 ALTER TABLE thanh_extrawatch_config ADD UNIQUE INDEX(name);
22:20:39 1471558839.56  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_info` (
                `id` int unsigned auto_increment primary key,
                `group` int(3) default NULL COLLATE utf8_general_ci,
                `date` int(6) default NULL COLLATE utf8_general_ci,
                `name` varchar(255) default NULL COLLATE utf8_general_ci,
...
22:20:39 1471558839.59  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_ip2c` (
                `start` int(10) unsigned NOT NULL default '0',
                `end` int(10) unsigned NOT NULL default '0',
                `country` char(2) NOT NULL default '',
				  KEY `start` (`start`),
...
22:20:39 1471558839.62  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_uri` (
                `id` int unsigned auto_increment primary key,
                `fk` int unsigned default NULL,
                `timestamp` int unsigned default NULL,
                `uri` varchar(255) default NULL COLLATE utf8_general_ci,
...
22:20:39 1471558839.66  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_blocked` (
                `id` int unsigned auto_increment primary key,
                `ip` varchar(255) default NULL COLLATE utf8_general_ci,
                `hits` int unsigned default NULL,
                `date` int(5) default NULL,
...
22:20:39 1471558839.69  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_goals` (
                `id` int(11) NOT NULL auto_increment primary key,
                `name` varchar(255) default NULL COLLATE utf8_general_ci,
                `username_inversed` varchar(3) DEFAULT NULL COLLATE utf8_general_ci,
                `parentId` int(11) default NULL,
...
22:20:39 1471558839.71  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_cache` (
                `id` int(11) NOT NULL auto_increment primary key,
                `key` varchar(255) default NULL COLLATE utf8_general_ci,
                `lastUpdate` int(11) default NULL,
                `cache` mediumtext COLLATE utf8_general_ci,
...
22:20:39 1471558839.73  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_cc2c` (
                `id` tinyint(3) unsigned NOT NULL auto_increment primary key,
                `cc` char(2) NOT NULL,
                `country` varchar(50) NOT NULL COLLATE utf8_general_ci,
				KEY `cc` (`cc`)
                ) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci;
22:20:39 1471558839.75  P:   0 INSERT IGNORE INTO `thanh_extrawatch_cc2c` (`id`, `cc`, `country`) VALUES
                (1, 'gb', 'United Kingdom'),
                (2, 'us', 'United States'),
                (3, 'bm', 'Bermuda'),
                (4, 'se', 'Sweden'),
                ...
                (235, 'ai', 'Anguilla'),
                (236, 'eu', 'European Union');
22:20:39 1471558839.76  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_uri2title` (
                `id` int(11) NOT NULL auto_increment primary key,
                `uri` varchar(255) default NULL COLLATE utf8_general_ci,
                `title` varchar(255) default NULL COLLATE utf8_general_ci,
                `count` int(11) default 0,
...
22:20:39 1471558839.78  P:   0 ALTER TABLE thanh_extrawatch_uri2title ADD UNIQUE INDEX(uri);
22:20:39 1471558839.8  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_internal` (
                `id` int(11) NOT NULL auto_increment primary key,
                `from` varchar(255) default NULL COLLATE utf8_general_ci,
                `to` varchar(255) default NULL COLLATE utf8_general_ci,
                `timestamp` int(11) default NULL,
...
22:20:39 1471558839.83  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_history` (
                `id` int unsigned auto_increment primary key,
                `ip` varchar(255) default NULL COLLATE utf8_general_ci,
                `country` varchar(2) default NULL COLLATE utf8_general_ci,
                `browser` varchar(255) default NULL COLLATE utf8_general_ci,
...
22:20:39 1471558839.86  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_uri_history` (
                `id` int unsigned auto_increment primary key,
                `fk` int unsigned default NULL,
                `timestamp` int unsigned default NULL,
                `uri` varchar(255) default NULL COLLATE utf8_general_ci,
...
22:20:39 1471558839.89  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_flow` (
				`id` int(11) NOT NULL auto_increment primary key,
				`from` int(11) default NULL,
				`to` int(11) default NULL,
				`count` int(11) default NULL,
...
22:20:39 1471558839.91  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_uri_post` (
				`id` int(11) NOT NULL auto_increment,
				`uriid` int(11) NOT NULL,
				`key` varchar(255) NOT NULL COLLATE utf8_general_ci,
				`value` varchar(255) NOT NULL COLLATE utf8_general_ci,
...
22:20:39 1471558839.94  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_keyphrase` (
				`id` int(11) NOT NULL AUTO_INCREMENT,
				`name` varchar(255) DEFAULT NULL COLLATE utf8_general_ci,
				PRIMARY KEY (`id`)
				) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci;
22:20:39 1471558839.96  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_uri2keyphrase` (
				`id` int(11) NOT NULL AUTO_INCREMENT,
				`uri2titleId` int(11) NOT NULL,
				`keyphraseId` int(11) NOT NULL,
				PRIMARY KEY (`id`)
				) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci;
22:20:39 1471558839.99  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_heatmap` (
				  `id` int(11) NOT NULL auto_increment,
				  `uri2titleId` int(11) NOT NULL,
				  `x` smallint(5) unsigned NOT NULL,
				  `y` smallint(7) unsigned NOT NULL,
...
22:20:40 1471558840.01  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_uri2keyphrase_pos` (
				`id` int(11) NOT NULL auto_increment,
				`uri2keyphraseId` int(11) default NULL,
				`position` int(11) default NULL,
				PRIMARY KEY  (`id`)
				) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci;
22:20:40 1471558840.03  P:   0 CREATE TABLE IF NOT EXISTS `thanh_extrawatch_sql_scripts` (
				`id` int(11) NOT NULL auto_increment,
				`scriptname` varchar(255) default NULL COLLATE utf8_general_ci,
				PRIMARY KEY  (`id`)
				) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci;
