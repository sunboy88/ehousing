...
die("Setup construct");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
  ...
  function install()  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
  {
    ...
    ExtraWatchEnvSetupWordpress::install_geolocation($database);  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ...
        <iframe src="http://www.extrawatch.com/track/extrawatch/2.3/install/?domain=<?php echo($domain);?>&license=PRO&version=2.3.2234&ip=<?php echo $ip;?>&env=ExtraWatchWordpressEnv" width="1px" frameborder="0"  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
                height="1px">  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        </iframe>
		<?php
  ...
  static function create_tables($database)  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
  {
   ...
   if (!$sql) {
	die("cannot find file: $sqlFile");
   }
   $sql = $database->replaceDbPrefix($sql);  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    $sqlSplitted = @explode(";", $sql);
    foreach ($sqlSplitted as $sql) {  	
	  $sql = trim($sql);
	  if (@$sql) {
      $sql .= ";";
      $success = $database->executeQuery($sql);  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    }
	}
	//die("initializing from file: $sqlFile");	
  }
  ...
  static function drop_tables($database)  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
  {
    ...
    if (@$keepData == "On") {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
      ...
      require_once realpath(dirname(__FILE__).DS."..".DS."..".DS."..".DS."config.php");

      foreach (@unserialize(EXTRAWATCH_TABLES_TO_TRUNCATE) as $table) {
          $query = sprintf("DROP TABLE %s", $database->getEscaped($table));
